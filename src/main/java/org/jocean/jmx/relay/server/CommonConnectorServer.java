/*
 * @(#)file      CommonConnectorServer.java
 ...
 */
public class CommonConnectorServer extends JMXConnectorServer {
...
// constructors
     ...
     *            some invalid values.
     */
    public CommonConnectorServer(Map env, MBeanServer mbs) {
	super(mbs);
	...
	public void run() {
		...
		try {
			...
			try {
			    logger.error("Receiver.run",
					 "stopping server"); 
			    CommonConnectorServer.this.stop();
